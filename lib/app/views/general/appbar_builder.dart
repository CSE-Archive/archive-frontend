...
import 'package:cse_archive/app/controllers/appbar.dart';
          ...
          children: [
            ...
            Expanded(
              ...
              child: searchBarBuilder(
                onInit: () {
                  if (PageTrackerService.to.activePage != ArchivePages.search) {
            ...
            Row(
              ...
              children: [
                ...
                CustomTextButton(
                  ...
                  staticUnderline: PageTrackerService.to.activePage ==
                      ArchivePages.references,
                ),
                const SizedBox(width: kSizeDefault),
                CustomTextButton(
