...
import 'package:cse_archive/app/controllers/teacher.dart';
import 'package:cse_archive/app/views/general/basic_web_page.dart';
import 'package:cse_archive/app/views/general/course_cards_builder.dart';
import 'package:cse_archive/app/views/general/custom_text_button.dart';
...
class TeacherView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.put(
      TeacherController(teacherId: int.parse(id!)),
      tag: id,
    );
