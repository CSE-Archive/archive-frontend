class ArchiveStrings {
  ...
  static const supportDonateDescription =
      'حمایت مالی شما به ما کمک می‌کنه تا هزینه‌های نگهداری از سایت، مثل هزینه‌های سرور و دامنه رو تامین کنیم. یکی از مهم‌ترین اهدافمون هم اینه که سرور دانلود اختصاصی‌ای تهیه کنیم که بتونیم به جای لینک تلگرام و گوگل درایو، براتون لینک مستقیم فایل‌ها رو بزاریم.';
  static const supportOtherTitle = 'حمایت غیرمالی';
  static const supportOtherDescription =
      'همچنین می‌تونی از ما به روش‌های دیگه‌ای هم حمایت کنی. این می‌تونه شامل موارد زیر باشه:';
  static const supportOtherCase1 =
      'ستاره دادن به رپوی این پروژه توی گیت‌هاب ما';
  static const supportOtherCase2 =
      'اشتراک گذاری لینک سایت توی رسانه‌های اجتماعی';
  static const supportOtherCase3 = 'گزارش هرگونه مشکل یا خطایی که بهش برخوردی';
  static const supportEnd = 'از حمایتت متشکریم!';
  ...
  static const aboutDescriptionP2 =
      'توی تیم آرشیو ما تمام تلاشمون رو می‌کنیم تا منابع درسی اعم از امتحانات ترم‌های گذشته، اسلایدهای اساتید، جزوه‌های درسی، کلاس‌های ضبط شده و ... رو جمع‌آوری کرده و به صورت رایگان توی یه مکان واحد برای استفاده‌ی عموم قرار بدیم.';
  ...
  static const contactDescriptionP1 =
      'از راه‌های ارتباطی زیر می‌تونی برای انتقال هرگونه پیشنهاد یا انتقاد سازنده‌ای که داری استفاده کنی.';
